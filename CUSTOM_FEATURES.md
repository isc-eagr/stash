...
- `ui/v2.5/src/components/Scenes/SceneDetails/SceneStatsPanel.tsx` - Renders compact sidebar overview bars plus the focused performer explorer, simultaneous Overall/Sex/Oral partner lanes, directional Sex/Oral/Both matrix, and sticky loop tray in a large detail modal
