...
// OCountByStudioID provides a mock function with given fields: ctx, studioID, depth, performerID
func (_m *ImageReaderWriter) OCountByStudioID(ctx context.Context, studioID int, depth *int, performerID *string) (int, error) {
	ret := _m.Called(ctx, studioID, depth, performerID)

	var r0 int
	if rf, ok := ret.Get(0).(func(context.Context, int, *int, *string) int); ok {
		r0 = rf(ctx, studioID, depth, performerID)
	} else {
		r0 = ret.Get(0).(int)
	}
	...
	if rf, ok := ret.Get(1).(func(context.Context, int, *int, *string) error); ok {
		r1 = rf(ctx, studioID, depth, performerID)
	} else {
		r1 = ret.Error(1)
	}
