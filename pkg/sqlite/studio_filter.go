...
func (qb *studioFilterHandler) criterionHandler() criterionHandler {
	...
	return compoundHandler{
		...
		activityPercentCriterionHandlerCustom(studioFilter.UnclassifiedActivityPercent, activityPercentStudioPercentExprCustom(activityPercentUnclassifiedCustom)), // CUSTOM
