...
INSERT INTO task_progress_goal_history(tracker_id,effective_on,goal_per_day) VALUES
 (1,'2026-09-07',2),
 (1,'2026-09-09',4),
 (1,'2026-09-10',NULL);`)
	...
	require.Len(t, tracker.History, 4)
	...
	require.Equal(t, 2, *tracker.History[0].GoalPerDay)
	require.Equal(t, 2, *tracker.History[1].GoalPerDay)
	require.Equal(t, 4, *tracker.History[2].GoalPerDay, "new goals apply from their effective date")
