...
export function getGroupSceneBaseMaximumCustom() {
  return (
    ...
    5 * GROUP_SCENE_WEIGHTS_CUSTOM.energy +
    5 * GROUP_SCENE_WEIGHTS_CUSTOM.participation +
    4 * GROUP_SCENE_WEIGHTS_CUSTOM.payoff +
    2 * GROUP_SCENE_WEIGHTS_CUSTOM.standout
  );
}
