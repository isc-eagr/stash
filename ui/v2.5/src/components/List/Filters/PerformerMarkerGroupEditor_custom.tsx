...
import { IPerformerMarkersGroup } from "src/models/list-filter/criteria/performer-markers";
import {
  PerformerIDSelect,
  Performer,
...
export const PerformerMarkerGroupEditor: React.FC<IGroupEditorProps> = ({
  group,
  onUpdate,
}) => {
  const intl = useIntl();
