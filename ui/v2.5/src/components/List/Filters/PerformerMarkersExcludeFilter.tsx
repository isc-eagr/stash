...
export const PerformerMarkersExcludeFilter: React.FC<IPerformerMarkersExcludeFilterProps> = ({
  criterion,
  setCriterion,
}) => {
    ...
    <div className="performer-markers-exclude-filter">
      <div className="mb-3 text-muted small">
        <FormattedMessage
          ...
          defaultMessage="Exclude performers with markers matching these criteria. Use 'Includes All' for AND mode (both performer AND partner must match), 'Includes' for OR mode (either can match)."
        />
      </div>
